<?php
    ...
    $count2 = "SELECT COUNT(*) as count FROM workers WHERE salary = 500";

    $like1 = "SELECT * FROM pages WHERE author LIKE '%Doe'";
    $like2 = "SELECT * FROM pages WHERE article LIKE '%element%'";
    $like3 = "SELECT * FROM workers WHERE age LIKE '2_'";
    $like4 = "SELECT * FROM workers WHERE name LIKE '%b'";
