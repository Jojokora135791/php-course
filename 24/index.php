<?php
    ...
    $or_and_1_query = "SELECT * FROM workers WHERE age = 27 or salary = 700";
    $or_and_2_query = "SELECT * FROM workers WHERE age = 27 or salary != 330";

    $insert = "INSERT INTO workers (name, age, salary) VALUES ('Mike', 22, 300)";
    $insert_query = mysqli_query($link, $insert) or die(mysqli_error($link));
    $insert_query_test = "SELECT * FROM workers WHERE name = 'Mike' and age = 11";

    $delete = "DELETE FROM `workers` WHERE id = 7";
    $delete_query = mysqli_query($link, $delete) or die(mysqli_error($link));

    $update1 = "UPDATE workers SET salary=200 WHERE name='Fill'";
    ...
    $update5 = "UPDATE workers SET name = 'Jack' , salary = 750 WHERE name = 'Fill'";
